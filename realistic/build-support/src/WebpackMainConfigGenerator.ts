...
/**
 * Generate Webpack configurations for the various Electron entry points: main process, renderer process, preload
 * scripts.
 */
export default class WebpackMainConfigGenerator {
  ...
  #mainProcessConfig: Configuration
  #rendererProcessNormalConfig: Configuration
  #rendererProcessPreloadConfig: Configuration

  static create(projectDir: string, envStrategy: EnvStrategy, port: number): WebpackMainConfigGenerator {
      const instance = new WebpackMainConfigGenerator(projectDir, envStrategy, port);
      instance.generateMainProcessConfig();
      instance.generateRendererProcessNormalConfig();
      instance.generateRendererProcessPreloadConfig();
      return instance;
  }
  ...
  public get mainProcessConfig(): Configuration {
      return this.#mainProcessConfig;
  }

  public get rendererProcessNormalConfig(): Configuration {
      return this.#rendererProcessNormalConfig;
  }

  public get rendererProcessPreloadConfig(): Configuration {
      return this.#rendererProcessPreloadConfig;
  }
  ...
  public generateRendererProcessNormalConfig() {
      ...
      this.#rendererProcessNormalConfig = config;
  }
  ...
  public generateRendererProcessPreloadConfig() {
      ...
      this.#rendererProcessPreloadConfig = config;
  }
}
